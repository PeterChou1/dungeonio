...
export class Player extends Phaser.Physics.Matter.Sprite {
    ...
    constructor(scene, x, y, clientid, playerName, scale = 2) {
        ...
        this.sensors = {
            ...
            bottom: Bodies.rectangle(0, h / 2 - 15, w * 0.80, 20, {
                isSensor: true,
            }),
            ...
            top: Bodies.rectangle(0, -h / 2 + 15, w * 0.80, 20, {
                isSensor: true,
            }),
        ...
        this.collisionContainer.setExistingBody(compoundBody)
                               .setFixedRotation();
        const playerState = {
            idle: new IdleState(),
            run: new RunState(),
    ...
    setFrameData() {
        ...
        if (this.anims.currentFrame) {
            ...
            const hitbox = PhysicsEditorParser.parseBody(0, 0, this.scene.frameData[this.anims.currentFrame.textureFrame]);
